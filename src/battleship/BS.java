...
public class BS extends Ship {
    ...
    public BS(char Direction) {
        super(Name, pieces, Direction);
    }
    public BS(String name, int[] pieces, char Direction) {
        super(name, pieces, 'H');
    }
    ...
    public Image[] frigateH()
    {
        ...
        imgShipsH[3] = new Image(battImgString("4"));
        imgShipsH[4] = new Image(battImgString("5"));
        return imgShipsH;
    }
    public Image[] frigateV()
    {
        ...
        imgShipsV[3] = new Image(battImgString("9"));
        imgShipsV[4] = new Image(battImgString("10"));
        return imgShipsV;
    }
